...
namespace MIMP.OperatingSystem.Windows.Native
{
    ...
    public enum ExtendedWindowStyle : uint
    {
        ...
        AcceptFiles = 0x00000010, // WS_EX_ACCEPTFILES
        ...
        /// </summary>
        ControlParent = 0x00010000, // WS_EX_CONTROLPARENT

        /// <summary>Specifies a window that has a double border.</summary>
        DialogModalFrame = 0x00000001, // WS_EX_DLGMODALFRAME
        ...
        /// </summary>
        LayoutRight2Left = 0x00400000, // WS_EX_LAYOUTRTL
        ...
        /// </summary>
        Left2RightReading = 0x00000000, // WS_EX_LTRREADING

        /// <summary>
        /// Specifies a multiple-document interface (MDI) child window.
        /// </summary>
        MultipleDocumentInterfaceChild = 0x00000040, // WS_EX_MDICHILD
        ...
        /// </summary>
        NoParentNotify = 0x00000004, // WS_EX_NOPARENTNOTIFY

        /// <summary>
        /// The window does not render to a redirection surface.
        /// This is for windows that do not have visible content or that use mechanisms other than surfaces to provide their visual.
        /// </summary>
        NoRedirectionBitmap = 0x00200000, // WS_EX_NOREDIRECTIONBITMAP

        /// <summary>Specifies an overlapped window.</summary>
        OverlappedWindow = WindowEdge | ClientEdge, // WS_EX_OVERLAPPEDWINDOW

        /// <summary>Specifies a palette window, which is a modeless dialog box that presents an array of commands.</summary>
        PaletteWindow = WindowEdge | ToolWindow | TopMost, // WS_EX_PALETTEWINDOW
        ...
        RightScrollbar = 0x00000000, // WS_EX_RIGHTSCROLLBAR

        /// <summary>
        /// Specifies a window that displays text using right-to-left reading-order properties.
        /// The shell language must support reading-order alignment for this to take effect.
        /// </summary>
        Right2LeftReading = 0x00002000, // WS_EX_RTLREADING
